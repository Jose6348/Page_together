      ...
      <div className="max-w-[1400px] mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-16">
          ...
          <div className="md:col-span-4">
            <h2 className="text-4xl font-light mb-8">Subscribe to newsletter</h2>
            <div className="relative border-b border-gray-300">
              <input
                type="email"
                placeholder="your@email.com"
                className="w-full py-3 pr-12 bg-transparent placeholder-gray-400 focus:outline-none"
              />
              <button 
          ...
          <div className="md:col-span-4">
            <nav className="space-y-4">
              <Link href="/products" className="block text-gray-600 hover:text-gray-900">Products</Link>
              <Link href="/solutions" className="block text-gray-600 hover:text-gray-900">Solutions</Link>
              <Link href="/research" className="block text-gray-600 hover:text-gray-900">Research</Link>
              ...
              <Link href="/status" className="block text-gray-600 hover:text-gray-900">Status</Link>
            </nav>
          ...
          <div className="md:col-span-4 flex flex-col justify-between">
            <div className="flex gap-4">
              <a 
                href="https://discord.gg/together" 
                target="_blank" 
              ...
              <a 
                href="https://twitter.com/together" 
                target="_blank" 
                rel="noopener noreferrer"
                className="p-2 rounded-full bg-gray-100 hover:bg-gray-200 transition-colors"
              >
              ...
              <a 
                href="https://linkedin.com/company/together" 
                target="_blank" 
                rel="noopener noreferrer"
                className="p-2 rounded-full bg-gray-100 hover:bg-gray-200 transition-colors"
              >
